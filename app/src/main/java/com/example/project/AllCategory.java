...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(9,R.drawable.ic_juice));
    ...
    private void setCategoryRecycler(List<AllCategoryModel> allcategoryModelList){
        ...
        AllCategoryRecycler.addItemDecoration(new GridSpacingItemDecoration(4, dpToPx(1), true));
